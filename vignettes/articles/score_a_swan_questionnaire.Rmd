...
2.  Be sure the following columns are present in the spreadsheet and
    ...
    | gender | The child's gender. <br><br> - Any and all gender values may be used to generate t-scores. <br> - To generate gender-normed t-scores, gender must be a binary (1 = Boy, 2 = Girl)<br> - There are no requirements to generate non-gendered t-scores | Non-gendered t-scores: any value <br><br> Gendered t-scores: 1 = Boy, 2 = Girl <br><br> Note: Any gender not coded as 1 or 2 will not receive a gendered t-score.  |
