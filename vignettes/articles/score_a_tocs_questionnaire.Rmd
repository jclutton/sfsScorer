...
If the data already exist within a dataframe in your environment, use `score_tocs2()` to score the dataframe. The scored columns will be added to your dataframe. 
